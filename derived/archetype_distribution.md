...
Dataset snapshot: **v0.2.0-rc-dryrun-11** · cutoff `2026-06-01` · commit `5cd78e4` · generated `2026-06-01T00:23:54Z` (events: 367)
...
| --- | ---: | --- |
| `l4_frontend+offramp_cex` | 21 | `binance-russia-exit-commex-2023`, `bitmex-cftc-doj-2020`, `cryptex-uaps-pm2btc-ivanov-shakhmametov-doj-2024`, `dydx-tornado-account-block-2022-08`, `garantex-besciokov-mira-serda-doj-2025`, `helix-doj-mixer-2020`, `india-fiu-offshore-vda-block-2023`, `indonesia-bappebti-illegal-exchange-block-2023`, `kucoin-doj-2024`, `liberty-reserve-coordinated-takedown-2013-05`, `malaysia-sc-binance-disable-2021`, `mtgox-bankruptcy-tokyo-2014`, `netherlands-dnb-binance-warning-2021`, `sec-beaxy-platform-shutdown-2023`, `sec-burnside-bitcoin-stock-exchange-2014`, `sec-voorhees-satoshidice-2014`, `sinbad-doj-2024`, `singapore-mas-binance-services-2021`, `singapore-mas-retail-crypto-restriction-2022`, `uk-fca-binance-markets-2021`, `uk-fca-crypto-promotion-rule-2023` |
...
| `cex_only` | 137 | 4 | 21 | 9 | 0 | 171 |
| `multi_layer` | 24 | 3 | 2 | 3 | 1 | 33 |
...
- `multi_layer` contains 33 events across 8 distinct signature(s). If signature diversity is low, claims about 'multi-layer cascade heterogeneity' should carry that caveat explicitly.

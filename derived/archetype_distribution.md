...
Dataset snapshot: **v0.2.0-rc-dryrun-11** · cutoff `2026-06-01` · commit `f70cc98` · generated `2026-06-01T00:48:55Z` (events: 367)
...
| `cex_only` | 138 | 4 | 21 | 9 | 0 | 172 |
| `multi_layer` | 23 | 3 | 2 | 3 | 1 | 32 |
...
- `multi_layer` contains 32 events across 8 distinct signature(s). If signature diversity is low, claims about 'multi-layer cascade heterogeneity' should carry that caveat explicitly.

...
Dataset snapshot: **v0.2.0-rc-dryrun-11** · cutoff `2026-06-01` · commit `cd97438` · generated `2026-06-01T00:00:00Z` (events: 368)
...
- `multi_layer` contains 36 events across 8 distinct signature(s). If signature diversity is low, claims about 'multi-layer cascade heterogeneity' should carry that caveat explicitly.

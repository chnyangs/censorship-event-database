...
Dataset snapshot: **v0.2.0-rc-dryrun-11** · cutoff `2026-06-01` · commit `8726393` · generated `2026-06-01T00:13:27Z` (events: 367)
...
| `cex_only` | 137 | 4 | 20 | 9 | 0 | 170 |
| `multi_layer` | 25 | 3 | 2 | 3 | 1 | 34 |
...
- `multi_layer` contains 34 events across 8 distinct signature(s). If signature diversity is low, claims about 'multi-layer cascade heterogeneity' should carry that caveat explicitly.

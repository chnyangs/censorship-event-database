...
Dataset snapshot: **v0.2.0-rc-dryrun-11** · cutoff `2026-06-08` · commit `7c8f923` · generated `2026-06-08T23:08:53Z` (events: 365)
...
| --- | ---: | ---: |
| `asset_only` | 14 | 3.8% |
| `frontend_only` | 44 | 12.1% |
| `cex_only` | 172 | 47.1% |
| `multi_layer` | 29 | 7.9% |
| `other_single_layer` | 9 | 2.5% |
| `null_event` | 97 | 26.6% |
| **total** | **365** | **100.0%** |
...
| `frontend_only` | 36 | 4 | 3 | 1 | 0 | 44 |
| `cex_only` | 140 | 4 | 20 | 8 | 0 | 172 |
| `multi_layer` | 22 | 3 | 1 | 2 | 1 | 29 |
| `other_single_layer` | 7 | 0 | 0 | 1 | 1 | 9 |
| `null_event` | 0 | 0 | 0 | 0 | 97 | 97 |

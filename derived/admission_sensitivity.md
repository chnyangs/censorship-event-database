...
Generated: `2026-06-01T12:19:10Z` · generator `scripts/build_admission_sensitivity.py` · corpus n = 365 events.
...
| `l4_frontend` | 30/54 = 0.556 | 49/54 = 0.907 | 68/76 = 0.895 | 0.3391 | **sensitive** |
| `asset_onchain` | 18/18 = retracted | 18/18 = retracted | 19/20 = retracted | — | **retracted_structural** |
| `offramp_cex` | 102/237 = 0.430 | 157/237 = 0.662 | 196/286 = 0.685 | 0.2549 | **sensitive** |

...
- Queue rows: 262
- Ready for future human audit: 175
...
| `human_audit_worksheet_preparation` | `complete` | `analysis/review_queue/human_audit_worksheet.csv` | Prepared 175 blank rows for future human audit; no audit result recorded. |

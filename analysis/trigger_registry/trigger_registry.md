...
| --- | ---: | ---: | ---: |
| raw registry rows | 238 | audit surface | — |
| distinct in-frame triggers | 145 | 150-250 milestone | 5 |
...
| temporal_tier | rows |
| --- | ---: |
| `comparable_main_2017_present` | 201 |
...
| `S4_nation_state` | 33 | 18 | 10 | 0 | 20 | 2 | 20 | 0 |

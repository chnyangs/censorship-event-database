...
(corpus at 365 admitted / 405 total; see
...
- [ ] **Claim-usable evidence repair.** `analysis/review-report.*` now excludes
      ...
      **285 high / 80 medium / 0 low**, and admitted attribution reliability **243 high / 122 medium / 0 low**.
      ...
      source-supported observation. Follow-on repair also moved `bitfinex-tether-cftc-2021` out of the queue
      with CFTC press-release plus dual-order PDF anchors, while dropping the stale Tether corporate URL as a
      non-usable live capture. Follow-on repair also moved `coinflip-cftc-derivabit-2015` out of the queue
      with CFTC press-release plus order-PDF anchors, while narrowing the row from an unverified frontend
      shutdown claim to the order-supported Derivabit trading-facility cease-and-desist / operator-state
      observation. Follow-on repair also moved `sec-burnside-bitcoin-stock-exchange-2014` out of the queue
      with SEC newsroom press-release plus corrected Administrative Proceeding Order 33-9685 anchors, while
      narrowing the row to the order-supported 2013 website/trading winddown and 2014 settlement remedies.
      Follow-on repair also moved `eu-russia-crypto-wallet-cap-2022` and
      `eu-russia-full-crypto-wallet-ban-2022` out of the queue with EUR-Lex Regulation 2022/576 and
      2022/1904 replay anchors, while narrowing both rows from unpinned named-CASP implementation claims to
      ...
      withdrawal observation. Follow-on repair also moved `uk-fca-binance-markets-2021` out of the queue with
      the FCA consumer-warning page plus First Supervisory Notice PDF pinned locally, while narrowing the row
      from an unpinned bank-payment-rail cascade to the FCA-supported BML regulated-business restriction plus
      required notice / promotion-removal compliance. Follow-on repair also moved
      `germany-bafin-binance-licence-withdrawal-2023` out of the low-observation queue with BaFin
      crypto-custody regime context plus PYMNTS and Reuters-syndicated reports pinned locally, while narrowing
      the row from an unpinned BaFin/Binance/L4 claim to the reported Binance Germany licence-application
      withdrawal under the BaFin/KWG regime and explicitly marking the evidence floor as
      `evidence_tier=attested_secondary`. Follow-on repair also moved
      ...
      source-supported ICO / credit-extension prohibition itself. Follow-on quality-loop audit rejected
      `binance-us-staking-end-2023` as an unsupported false-positive / duplicate-scope row: replayable
      Binance.US and Guardian anchors support the SEC-v-Binance platform/off-ramp reaction already admitted
      in `sec-v-binance-2023`, not a standalone 2023-06-09 all-staking shutdown. Follow-on quality-loop
      audit recoded `kraken-sec-unregistered-exchange-2023` from a positive empirical observed-change row to
      a null-control no-service-withdrawal comparator, with SEC and Kraken replay anchors pinned locally for
      the November 2023 unregistered-exchange complaint and same-day platform response. Follow-on repair
      also moved `sec-v-ripple-2020` out of the low-observation queue with local SEC, Coinbase, and Bitstamp
      replay anchors, while narrowing the row from a broad two-layer/four-exchange cascade to the
      source-supported Coinbase/Bitstamp CEX/off-ramp comparison and dropping unanchored Ripple.com L4,
      Binance.US, and Kraken observations from the admitted observation set. Follow-on repair also moved
      ...
      Follow-on repair also moved `singapore-mas-binance-services-2021` out of the low-observation queue by
      replacing generic MAS news-index citations with a replayable 2021-09-02 CNA trigger report and two
      first-party Binance Wayback captures for the 2021-09-05 SGD/app-store restrictions and 2021-09-27
      ...
      Follow-on repair also moved `netherlands-dnb-binance-warning-2021` out of the low-observation queue by
      replacing generic DNB homepage / contextual Wayback patterns with pinned official DNB warning,
      enforcement-page, and fine-decision PDF captures; the row is recoded as `regulatory_enforcement` and
      narrowed to DNB's warning/fine for unregistered Binance exchange and custody services in the Netherlands,
      with no retained claim about an unpinned frontend/user-offboarding cascade or the later 2023 market exit.
      Follow-on repair also moved `opensea-iran-cuba-sanctions-block-2022` out of the low-observation queue by
      replacing generic OpenSea blog / wildcard Wayback scaffolding with dated 2022 OpenSea TOS Wayback captures
      ...
      Follow-on low-observation cleanup cleared the admitted low-observation queue entirely: `mtgox-dhs-dwolla-wells-fargo-seizure-2013`
      now has a replayable primary-legal warrant copy; `oecd-carf-2022` now has a replayable official OECD
      consolidated CARF PDF anchor; `voyager-bankruptcy-doj-objection-2023` is explicitly recoded
      ...
      Follow-on primary-trigger repair also moved `binance-monero-global-delisting-2024-02` out of the blocked
      queue by pinning the official Binance Support mirror on `binance.info` locally. The `binance.com` live
      page returned a WAF challenge on this network path, so the replayable mirror capture is the claim-usable

...
- [ ] **Claim-usable evidence repair.** `analysis/review-report.*` now excludes
      ...
      **244 release-ready** cases, **124 admitted-but-blocked** cases, observation reliability
      **262 high / 80 medium / 26 low**, and attribution reliability **225 high / 143 medium / 0 low**.

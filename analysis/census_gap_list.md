...
| `tether-okx-doj-pig-butchering-225m-freeze-2025-06` | Resolved 2026-05-31: S5/S3 duplicate merged into one S3-modeled draft keyed to the DOJ D.D.C. forfeiture / Tether burn-reissue stage. It is downstream of corpus `tether-doj-pig-butchering-freeze-2023` (same seven Token Group addresses later enumerated by the D.D.C. complaint), not a second new 2025 freeze cohort. |
...
| **$225M pig-butchering forfeiture** | S3 `pig-butchering-225m-civil-forfeiture-doj-2025` ↔ S5 `tether-okx-doj-pig-butchering-225m-freeze-2025-06` ↔ S5 `dprk-it-worker-laundering-civil-forfeiture-doj-2025` (different — $7.74M) | DONE for 225M pair: modeled as one S3 draft with DOJ as trigger and Tether/OKX as executor; keep $7.74M separate. |

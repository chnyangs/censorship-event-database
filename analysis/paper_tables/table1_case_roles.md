...
| `aeza-group-ofac-2025` | `empirical_case` | `S1_ofac_sdn` | `comparison` | `ofac_sdn_designation` | `day` | `entity` | `subset` | 1 | `asset_only` | · | · | `2026-06-02` | `—` |
...
| `bangladesh-bank-fepd-virtual-assets-prohibition-2022-09` | `empirical_case` | `S4_nation_state` | `comparison` | `nation_state_block` | `day` | `entity` | `subset` | 1 | `cex_only` | · | · | `2026-05-31` | `—` |
...
| `binance-uk-new-user-halt-2023-10` | `empirical_case` | `S5_corporate` | `comparison` | `corporate_policy_change` | `day` | `entity` | `complete` | 1 | `cex_only` | ✓ | · | `2026-06-01` | `—` |
| `bitcoin-maven-tetley-doj-2018` | `empirical_case` | `S3_doj_sec_cftc_fiod` | `comparison` | `doj_indictment` | `day` | `entity` | `subset` | 1 | `cex_only` | · | · | `2026-05-31` | `—` |
...
| `bitfinex-us-retail-customer-exit-2017-11` | `empirical_case` | `S5_corporate` | `comparison` | `corporate_policy_change` | `day` | `entity` | `complete` | 1 | `cex_only` | · | · | `2026-05-31` | `—` |
...
| `bitriver-russia-mining-ofac-2022-04` | `null_case` | `S1_ofac_sdn` | `null_event` | `ofac_sdn_designation` | `day` | `entity` | `subset` | 0 | `null_event` | · | · | `2026-06-02` | `2026-05-31` |
...
| `bitzlato-doj-2023` | `empirical_case` | `S3_doj_sec_cftc_fiod` | `comparison` | `doj_indictment` | `day` | `entity` | `complete` | 1 | `cex_only` | · | · | `2026-06-02` | `—` |
| `blender-ofac-2022` | `empirical_case` | `S1_ofac_sdn` | `comparison` | `ofac_sdn_designation` | `day` | `address_set` | `complete` | 1 | `frontend_only` | · | · | `2026-06-02` | `—` |
...
| `btc-e-doj-2017` | `empirical_case` | `S3_doj_sec_cftc_fiod` | `comparison` | `doj_indictment` | `day` | `entity` | `subset` | 1 | `frontend_only` | · | · | `2026-06-02` | `—` |
...
| `bybit-france-exit-2024-12` | `empirical_case` | `S5_corporate` | `comparison` | `corporate_policy_change` | `day` | `entity` | `complete` | 1 | `cex_only` | · | · | `2026-06-01` | `—` |
...
| `cambodia-kok-an-pig-butchering-crypto-2026` | `null_case` | `S1_ofac_sdn` | `null_event` | `ofac_sdn_designation` | `day` | `entity` | `subset` | 0 | `null_event` | · | · | `2026-06-08` | `—` |
| `cambodia-nbc-joint-crypto-prohibition-2018-05` | `empirical_case` | `S4_nation_state` | `comparison` | `nation_state_block` | `day` | `entity` | `subset` | 1 | `cex_only` | · | · | `2026-06-01` | `—` |
...
| `celsius-multistate-cease-desist-earn-2021-09` | `empirical_case` | `S4_nation_state` | `comparison` | `regulatory_enforcement` | `day` | `entity` | `subset` | 1 | `cex_only` | · | · | `2026-05-31` | `—` |
...
| `chatex-ofac-2021` | `empirical_case` | `S1_ofac_sdn` | `comparison` | `ofac_sdn_designation` | `day` | `address_set` | `complete` | 2 | `multi_layer` | · | · | `2026-06-02` | `—` |
...
| `circle-freeze-zama-cusdc-court-order-2026` | `null_case` | `S5_corporate` | `null_event` | `corporate_policy_change` | `day` | `asset` | `subset` | 0 | `null_event` | · | · | `2026-06-08` | `—` |
...
| `circle-usdc-multichain-hack-freeze-2023-07` | `empirical_case` | `S5_corporate` | `comparison` | `corporate_policy_change` | `hour` | `address_set` | `subset` | 1 | `asset_only` | ✓ | · | `2026-05-31` | `—` |
| `circle-usdc-sealed-civil-case-16-address-freeze-2026-03` | `empirical_case` | `S5_corporate` | `comparison` | `corporate_policy_change` | `day` | `address_set` | `complete` | 1 | `asset_only` | · | · | `2026-05-31` | `—` |
...
| `colonial-pipeline-darkside-ransom-clawback-doj-2021` | `empirical_case` | `S3_doj_sec_cftc_fiod` | `comparison` | `doj_seizure_order` | `day` | `address_set` | `complete` | 1 | `asset_only` | · | · | `2026-05-31` | `—` |
...
| `crypto-capital-fowler-doj-2019` | `empirical_case` | `S3_doj_sec_cftc_fiod` | `comparison` | `doj_indictment` | `day` | `entity` | `subset` | 1 | `cex_only` | · | · | `2026-05-31` | `—` |
...
| `dprk-it-workers-amnokgang-vietnam-2026` | `null_case` | `S1_ofac_sdn` | `null_event` | `ofac_sdn_designation` | `day` | `entity` | `subset` | 0 | `null_event` | · | · | `2026-06-08` | `—` |
| `dprk-song-kum-hyok-andariel-it-workers-2025` | `null_case` | `S1_ofac_sdn` | `null_event` | `ofac_sdn_designation` | `day` | `entity` | `subset` | 0 | `null_event` | · | · | `2026-06-08` | `—` |
...
| `ethiopia-nbe-exchange-website-block-2025-11` | `empirical_case` | `S4_nation_state` | `comparison` | `nation_state_block` | `day` | `entity` | `subset` | 1 | `other_single_layer` | · | · | `2026-06-08` | `—` |
| `ethiopia-nbe-p2p-birr-crypto-ban-2026-02` | `empirical_case` | `S4_nation_state` | `comparison` | `regulatory_enforcement` | `day` | `asset` | `subset` | 1 | `cex_only` | · | · | `2026-06-08` | `—` |
...
| `eu-belarus-crypto-wallet-ban-2025` | `empirical_case` | `S6_supranational` | `comparison` | `non_us_sanctions` | `day` | `entity` | `subset` | 1 | `cex_only` | · | · | `2026-06-08` | `—` |
...
| `falcon-labs-cftc-us-access-ban-2024` | `empirical_case` | `S3_doj_sec_cftc_fiod` | `comparison` | `cftc_action` | `day` | `entity` | `subset` | 1 | `cex_only` | · | · | `2026-06-08` | `—` |
...
| `fayzimatov-alqaeda-syria-ofac-2021-07` | `null_case` | `S1_ofac_sdn` | `null_event` | `ofac_sdn_designation` | `day` | `address_set` | `complete` | 0 | `null_event` | · | · | `2026-05-31` | `—` |
...
| `jordan-cbj-bank-crypto-prohibition-2014` | `empirical_case` | `S4_nation_state` | `comparison` | `nation_state_block` | `day` | `entity` | `subset` | 1 | `cex_only` | · | · | `2026-06-02` | `—` |
...
| `kucoin-cftc-permanent-us-ban-2026` | `empirical_case` | `S3_doj_sec_cftc_fiod` | `comparison` | `cftc_action` | `day` | `entity` | `subset` | 1 | `cex_only` | · | · | `2026-06-08` | `—` |
...
| `kuwait-cma-virtual-assets-prohibition-2023-07` | `empirical_case` | `S4_nation_state` | `comparison` | `nation_state_block` | `day` | `entity` | `subset` | 1 | `cex_only` | · | · | `2026-05-31` | `—` |
...
| `magic-eden-ofac-sanctioned-country-block` | `empirical_case` | `S5_corporate` | `comparison` | `corporate_policy_change` | `day` | `domain` | `subset` | 1 | `frontend_only` | ✓ | · | `2026-06-01` | `—` |
...
| `morocco-office-des-changes-crypto-ban-2017-11` | `empirical_case` | `S4_nation_state` | `comparison` | `regulatory_enforcement` | `day` | `entity` | `subset` | 1 | `cex_only` | · | · | `2026-06-01` | `—` |
...
| `netwalker-vachon-desjardins-doj-2022` | `null_case` | `S3_doj_sec_cftc_fiod` | `null_event` | `doj_seizure_order` | `day` | `entity` | `subset` | 0 | `null_event` | · | · | `2026-05-31` | `—` |
...
| `nigeria-sec-binance-cease-solicitation-2023-07` | `empirical_case` | `S4_nation_state` | `comparison` | `regulatory_enforcement` | `day` | `entity` | `subset` | 1 | `cex_only` | · | · | `2026-06-08` | `—` |
| `nobitex-iran-exchanges-economic-fury-2026` | `null_case` | `S1_ofac_sdn` | `null_event` | `ofac_sdn_designation` | `day` | `entity` | `subset` | 0 | `null_event` | · | · | `2026-06-08` | `—` |
...
| `nydfs-bittrex-bitlicense-denial-2019-04` | `empirical_case` | `S4_nation_state` | `comparison` | `regulatory_enforcement` | `day` | `entity` | `complete` | 1 | `cex_only` | · | · | `2026-05-31` | `—` |
...
| `semenov-ofac-2023` | `empirical_case` | `S1_ofac_sdn` | `comparison` | `ofac_sdn_designation` | `day` | `address_set` | `complete` | 1 | `asset_only` | · | · | `2026-06-02` | `2026-04-22` |
...
| `sinaloa-cartel-eth-addresses-fentanyl-2026` | `null_case` | `S1_ofac_sdn` | `null_event` | `ofac_sdn_designation` | `day` | `address_set` | `complete` | 0 | `null_event` | · | · | `2026-06-08` | `—` |
...
| `sinbad-ofac-2023` | `null_case` | `S1_ofac_sdn` | `null_event` | `ofac_sdn_designation` | `day` | `address_set` | `complete` | 0 | `null_event` | · | · | `2026-06-02` | `2026-05-15` |
| `singapore-mas-binance-services-2021` | `empirical_case` | `S4_nation_state` | `comparison` | `nation_state_block` | `day` | `entity` | `subset` | 2 | `multi_layer` | · | · | `2026-06-02` | `—` |
...
| `suex-ofac-2021` | `empirical_case` | `S1_ofac_sdn` | `comparison` | `ofac_sdn_designation` | `day` | `address_set` | `complete` | 1 | `asset_only` | · | · | `2026-06-02` | `—` |
...
| `t3-bybit-hack-usdt-freeze-2025-03` | `empirical_case` | `S5_corporate` | `comparison` | `corporate_policy_change` | `hour` | `address_set` | `subset` | 1 | `asset_only` | ✓ | · | `2026-06-01` | `—` |
| `t3-financial-crime-unit-launch-2024-09` | `empirical_case` | `S5_corporate` | `comparison` | `corporate_policy_change` | `day` | `address_set` | `subset` | 1 | `asset_only` | · | · | `2026-05-31` | `—` |
...
| `task-force-rusich-ofac-2022-09` | `null_case` | `S1_ofac_sdn` | `null_event` | `ofac_sdn_designation` | `day` | `entity` | `subset` | 0 | `null_event` | · | · | `2026-05-31` | `—` |
...
| `terror-financing-crypto-seizure-doj-2020` | `empirical_case` | `S3_doj_sec_cftc_fiod` | `comparison` | `doj_seizure_order` | `day` | `entity` | `subset` | 1 | `frontend_only` | · | · | `2026-05-31` | `—` |
...
| `tether-ofac-iran-economic-fury-344m-freeze-2026-04` | `empirical_case` | `S5_corporate` | `comparison` | `corporate_policy_change` | `day` | `address_set` | `complete` | 1 | `asset_only` | · | · | `2026-05-31` | `—` |
| `tether-okx-doj-pig-butchering-225m-freeze-2025-06` | `empirical_case` | `S3_doj_sec_cftc_fiod` | `comparison` | `doj_seizure_order` | `day` | `address_set` | `complete` | 1 | `asset_only` | · | · | `2026-05-31` | `—` |
...
| `thailand-sec-unlicensed-exchange-block-2025-06` | `empirical_case` | `S4_nation_state` | `comparison` | `nation_state_block` | `day` | `entity` | `subset` | 1 | `other_single_layer` | · | · | `2026-06-08` | `—` |
...
| `tradehill-dwolla-payment-cutoff-2012-02` | `empirical_case` | `S5_corporate` | `comparison` | `corporate_policy_change` | `day` | `entity` | `complete` | 1 | `cex_only` | ✓ | · | `2026-06-02` | `2026-05-31` |
...
| `zedcex-zedxion-irgc-iran-2026` | `null_case` | `S1_ofac_sdn` | `null_event` | `ofac_sdn_designation` | `day` | `entity` | `subset` | 0 | `null_event` | · | · | `2026-06-08` | `—` |

...
## Panel B · Day-precision triggers (n=32)
...
| (1d, 30d] | 8 | `aeza-group-ofac-2025`, `blender-ofac-2022`, `chatex-ofac-2021`, `lockbit-affiliates-ofac-2024`, `sec-v-binance-2023`, `semenov-ofac-2023`, `suex-ofac-2021`, `turkey-cbrt-crypto-ban-2021` |
...
## Panel C · Excluded from both panels — `trigger_is_action` (n=6)

| event_id | trigger_type |
| --- | --- |
| `circle-usdc-tornado-2022` | `corporate_policy_change` |
| `coinbase-india-exit-2022` | `corporate_policy_change` |

...
**Dataset version**: `0.2.0-rc-dryrun-11` · **Dataset cutoff**: `2026-06-02` · **Source commit**: `38556e8` · **Schema**: `0.2.0` · **Event last_verified**: `2026-05-31` · **Tool version**: `0.1.0` · **Generated**: `2026-06-02T00:00:00Z`
...
- **l0_network** (`not_measured`): No OONI / Censored Planet probe of Genesis Market domains within the
- **l4_frontend** (`not_measured`): Genesis Market's domains were seized in the parallel Operation

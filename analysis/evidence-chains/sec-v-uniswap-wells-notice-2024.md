...
**Dataset version**: `0.1.0` · **Dataset cutoff**: `2026-05-06` · **Source commit**: `947f18f` · **Schema**: `0.2.0` · **Event last_verified**: `2026-05-06` · **Tool version**: `0.1.0` · **Generated**: `2026-05-06T10:56:34Z`
...
> Binance/Coinbase complaint files are now admitted only as scoped
> CEX/platform-service comparison rows after platform or rail artifacts
> were pinned directly.

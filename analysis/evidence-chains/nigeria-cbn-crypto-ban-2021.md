...
- **`supporting_journalism`**
  - URL: <https://web.archive.org/web/2021*/reuters.com/article/us-nigeria-banks-cryptocurrency-idUKKBN2A60CD>
  - Wayback: <https://web.archive.org/web/2021*/reuters.com/article/us-nigeria-banks-cryptocurrency-idUKKBN2A60CD>
  > Reuters reporting on the CBN action and its market consequences — deferred
> archival pinning (Wayback URL pattern).
